...
@section('content')
    ...
    @if ($genre)
        ...
        <div class="col-12 col-md-6 offset-md-3 p-4 border" id="register">
            <br>
            <h2 class="col-10 ">Updating genre successfull</h2>
            <br>
            <form class="row g-3 " class="col-12">
                <span class="text-success">The genre has been updated successfully</span>
                <div class="col-6">
    ...
    @else
        ...
        <div class="col-12 col-md-6 offset-md-3 p-4 border" id="register">
            <br>
            <h2 class="col-10 ">Updating genre Failed</h2>
            <br>
            <form class="row g-3 " class="col-12">
                <span class="text-danger">An error occured when updating this genre</span>
                <div class="col-12">
