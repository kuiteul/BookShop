...
@section('content')
    ...
    @if ($users)
        ...
        <div class="col-12 col-md-6 offset-md-3 p-4 border" id="register">
            <br>
            <h2 class="col-10 ">Banning user successfull</h2>
            <br>
            <form class="row g-3 " class="col-12">
                <span class="text-success">The users has been banned successfully</span>
                <div class="col-6">
    ...
    @else
        ...
        <div class="col-12 col-md-6 offset-md-3 p-4 border" id="register">
            <br>
            <h2 class="col-10 ">Banning user Failed</h2>
            <br>
            <form class="row g-3 " class="col-12">
                <span class="text-danger">An error occured when banning this users</span>
                <div class="col-12">
